import { ChevronDown, House, SlidersHorizontal, XIcon } from "lucide-react";
    ...
    <div className="min-h-screen bg-app-cream ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          <span>/</span>
          <span className="text-app-green font-medium">All products</span>
        </nav>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  <select className="appearance-none pl-3 pr-8 py-2 text-sm bg-white rounded-xl border border-app-border focus:border-app-green outline-none cursor-pointer">
      ...
      {mobileFiltersOpen && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh] overflow-y-auto animate-slide-in-up">
            <div className="flex justify-between p-4 items-center border-b border-app-border">
