...
const Banner = () => {
  ...
  return (
    <div>
      {bannerVisible && (
        <div className="bg-linear-to-r from-app-green via-emerald-800 to-app-green text-white text-xs sm:text-sm overflow-hidden relative">
          <div className="flex-center gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
